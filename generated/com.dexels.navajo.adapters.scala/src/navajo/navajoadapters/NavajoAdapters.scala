package navajo.navajoadapters

import com.dexels.navajo.scala.document._

import com.dexels.navajo.scala._

trait NavajoAdapters extends com.dexels.navajo.scala.BaseAdapters with com.dexels.navajo.scala.Base { self: com.dexels.navajo.scala.ScalaCompiledScript => 
  def GetSequenceValue(arg0: java.lang.Integer, arg1: java.lang.String) {
  ...
  def GetSequenceValue(arg0: java.lang.Integer) {
    val function = this.setupFunction(new com.dexels.navajo.adapter.functions.GetSequenceValue)
    function.insertOperand(arg0)
  }
  def GetSequenceValue(arg0: java.lang.String, arg1: java.lang.String) {
    val function = this.setupFunction(new com.dexels.navajo.adapter.functions.GetSequenceValue)
    function.insertOperand(arg0)
    function.insertOperand(arg1)
  }
  def GetSequenceValue(arg0: java.lang.String) {
    val function = this.setupFunction(new com.dexels.navajo.adapter.functions.GetSequenceValue)
    function.insertOperand(arg0)
  }
